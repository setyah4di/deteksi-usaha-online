...
// ─── Client-side exclusion filter (defensive layer) ──────────────────────────
// Kata kunci nama yang menandakan bukan usaha digital
...
const DashboardPage = () => {
    ...
    const searchNearby = async () => {
        ...
        try {
            ...
            // Filter defensif di sisi klien — buang usaha non-digital yang lolos backend
